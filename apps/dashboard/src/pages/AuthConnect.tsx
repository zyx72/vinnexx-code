  ...
  return (
    <section className="auth-wrap">
      <div className="panel auth-card">
        ...
        <p>Approving gives this terminal access to your Vinnexx account, plan, memory and Vinnexx model quota. Local project access remains controlled by the terminal.</p>
